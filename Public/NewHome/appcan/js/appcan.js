...
window.appcan && appcan.define('window',function($,exports,module){
    ...
    */
    ...
    /*
    浮动窗口伸缩动画
    @param Number x 相对于当前大小的x轴方向上的放大兑换额，大于0的float型数据
    @param Number y 相对于当前大小的y轴方向上的放大兑换额，大于0的float型数据
    @param Number z 相对于当前大小的z轴方向上的放大兑换额，大于0的float型数据
    ...
    */
    ...
    @param Number scaleX 相对于当前大小的x轴方向上的放大兑换额，大于0的float型数据
    @param Number scaleY 相对于当前大小的y轴方向上的放大兑换额，大于0的float型数据
    @param Number scaleZ 相对于当前大小的z轴方向上的放大兑换额，大于0的float型数据
    @param Number degrees 相对于当前角度的旋转度数
